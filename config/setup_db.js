...
db.connect(function (err) {
	...
	// db.query(`INSERT IGNORE INTO matcha.users (userId, username, firstName, lastName, age, email, password, tokenmail, mail_active, gender, bio, sexpref, geoloc, position, lastConnection) VALUES (1, 'azeghmi', 'Amine', 'Zeghmi', 30, 'azeghmi@student.42.fr', 'sha1$8d9699b2$1$e0bd6ac8363f4d052fbf8b614db47aa64ededb70', 'c38846c42a595dd7a1f06e3281452bcf', 1, 'Man', 'Ma bio', 'Heterosexual', '48.8823464, 2.3118558', '', 'Jul 7, 2020');`,
	// 	function (err) {
	// 		if (err) throw err;
	// 	});
